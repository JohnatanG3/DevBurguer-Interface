...
Projeto desenvolvido com foco em prática de arquitetura front-end moderna com React, integração com API REST, autenticação, contexto global de estado e fluxo real de compra.
